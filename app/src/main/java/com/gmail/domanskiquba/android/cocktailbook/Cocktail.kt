...
import com.gmail.domanskiquba.android.cocktailbook.api.TheSingleCocktailResponse
...
class Cocktail {
    ...
    var drinkName = ""
    constructor(cocktailResponse: TheSingleCocktailResponse) {
        id = cocktailResponse.idDrink ?: id
        drinkName = cocktailResponse.strDrink ?: ""

        /*@SerializedName("idDrink") val idDrink : Int? = null
